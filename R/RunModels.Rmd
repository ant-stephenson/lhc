...
for(j in 1:G){
  ...
  #get a plot of the k ROC curves on the same axis
  ams_obj[[i1]]$plot_ams(lgd=paste0("Max(<AMS>/mad) at p=", round(average_max_thresh, 2)))
  for (k in 2:K) {
