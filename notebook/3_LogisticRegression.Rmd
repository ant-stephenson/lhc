...
## Run CV experiments
Now we run our cross-validation experiment, looping over jet groups and folds and fitting a model for each (so $GK$ in total) and then test each of these on their OOS subset, recording AUC and AMS.
```{r fitting}
# loop over folds
